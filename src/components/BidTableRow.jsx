...
const BidTableRow = ({ bid, handleStatusSubmit }) => {
  const { job_title, offer_deadline, price, category, status, _id } = bid || {};
    ...
    <tr>
      ...
      <td className="px-4 py-4 text-sm whitespace-nowrap">
        ...
        <button
          ...
          onClick={() => handleStatusSubmit(_id, status, "Complete")}
          title="Mark Complete"
          className="text-gray-500 transition-colors duration-200   hover:text-red-500 focus:outline-none  disabled:hover:cursor-not-allowed"
        >
          <svg
